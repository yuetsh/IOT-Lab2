...
const DATA: Row[] = [
  ...
  { area: '身份识别', function: '身份识别是否通过', device: '超高频标签' },
  ...
  { area: 'LED显示', function: '实时显示日期与时间', device: '串口服务器' },
  { area: 'LED显示', function: '实时显示日期与时间', device: 'LED显示器' },
  { area: 'LED显示', function: '实时推送温湿度与空气质量', device: '串口服务器' },
  { area: 'LED显示', function: '实时推送温湿度与空气质量', device: 'LED显示器' },
  { area: 'LED显示', function: '滚动播放通知与新书推荐', device: '串口服务器' },
  { area: 'LED显示', function: '滚动播放通知与新书推荐', device: 'LED显示器' },
  { area: 'LED显示', function: '同步显示安防与门禁状态', device: '串口服务器' },
  { area: 'LED显示', function: '同步显示安防与门禁状态', device: 'LED显示器' },
  ...
  { area: '自助系统', function: '读取图书标签（借书）', device: '超高频中距离一体机' },
  { area: '自助系统', function: '读取图书标签（借书）', device: '超高频标签' },
  { area: '自助系统', function: '读取图书标签（还书）', device: '超高频中距离一体机' },
  { area: '自助系统', function: '读取图书标签（还书）', device: '超高频标签' },
